...
$_['text_guest']           = '<p>Ваш заказ принят!</p><p>Наши менеджеры свяжутся с Вами, для подтверждения заказа и уточнения деталей.</p><p>Спасибо за покупки в нашем интернет-магазине!</p>';
