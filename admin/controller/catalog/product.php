...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['price_m2'])) {
			$data['price_m2'] = $this->request->post['price_m2'];
		} elseif (!empty($product_info)) {
			$data['price_m2'] = $product_info['price_m2'];
		} else {
			$data['price_m2'] = '';
		}
...
// ALTER TABLE `oc_product_option_value` DROP COLUMN `1`;


		// $this->db->query("ALTER TABLE " . DB_PREFIX . "product_option_value ADD COLUMN `color` VARCHAR(255) NOT NULL AFTER `price`");
		// $this->db->query("ALTER TABLE " . DB_PREFIX . "product_option_value ADD COLUMN `size` VARCHAR(255) NOT NULL AFTER `price`");

		// $this->db->query("ALTER TABLE " . DB_PREFIX . "product ADD COLUMN `price_m2` VARCHAR(255) NOT NULL AFTER `price`");
